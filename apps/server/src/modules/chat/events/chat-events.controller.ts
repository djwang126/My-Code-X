...
function writeSseEvent(response: any, eventName: any, payload: any) {
...
function readEventDebugTurnId(event: any) {
...
export function handleChatEventsRoute(request: any, response: any, { chatService }: any) {
