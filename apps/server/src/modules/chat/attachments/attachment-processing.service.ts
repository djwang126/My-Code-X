...
function getNormalizedDimensions(metadata: any) {
...
function scaleDimensions(dimensions: any) {
...
async function inspectImageMetadata({ imageAdapter, sourcePath }: any) {
    try {
...
function assertImageWithinSafetyLimits(metadata: any) {
...
export function createAttachmentProcessingService({ outputRoot, imageAdapter, logger, randomId = () => `att-${Date.now()}`, }: any) {
    async function processAttachment({ sourcePath, originalFilename, contentType }: any) {
