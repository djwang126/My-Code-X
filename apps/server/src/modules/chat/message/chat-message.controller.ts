...
function logSendDebug(stage: any, details: any = {}) {
...
function splitRuntimeSettingsCollaborationMode(runtimeSettings: any) {
...
export async function handleChatMessageRoute(request: any, response: any, { chatService }: any) {
