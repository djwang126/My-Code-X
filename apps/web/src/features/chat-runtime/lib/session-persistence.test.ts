...
import { loadStoredRuntimePreferences, persistRuntimePreferences } from '../../runtime-settings';
import {
...
describe('session persistence', () => {
  ...
  it('does not persist thread history onto a saved workspace when relabeling it', () => {
    setSlotUrl('slot-1');
    saveWorkspace({
      path: 'D:/workspaces/My-Code-X',
      label: 'My-Code-X',
