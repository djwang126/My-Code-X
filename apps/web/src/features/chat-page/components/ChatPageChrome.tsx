...
import { RuntimeSettingsDrawer } from '../../runtime-settings';
import { ThreadToolsSidebar } from '../../thread-tools';
import { WorkspaceFileExplorer, WorkspaceSidebar } from '../../workspace-sidebar';
...
import { getRuntimeSelectOptions, getStatusClass } from '../lib/chat-page-view';
...
type ChatPageChromeProps = {
  ...
  threadHistory: NonNullable<ChatPageProps['threadHistory']>;
  ...
  onStartEditingWorkspace: (workspace: { path: string; label: string }) => void;
  onThreadHistoryOpen?: ChatPageProps['onThreadHistoryOpen'];
  ...
  return (
    <>
      ...
      <WorkspaceSidebar
        ...
        onThreadHistoryOpen={props.onThreadHistoryOpen}
        ...
        threadHistory={props.threadHistory}
        threadHistoryError={props.threadHistoryError}
        threadHistoryLoading={props.threadHistoryLoading}
