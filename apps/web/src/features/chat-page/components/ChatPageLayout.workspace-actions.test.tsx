...
describe('ChatPageLayout workspace and thread actions', () => {
  ...
  it(
    ...
    const onThreadHistoryOpen = vi.fn(async () => true);
    ...
    await waitFor(() => expect(onThreadHistoryOpen).toHaveBeenCalledWith('thread-17'));
    },
    10_000,
  );

  it('renders thread action buttons and calls their handlers', async () => {
