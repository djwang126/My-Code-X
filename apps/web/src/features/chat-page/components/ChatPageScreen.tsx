...
import { selectChatPageFeedback } from '../state/chat-page-feedback-selector';
...
export function ChatPageScreen() {
  ...
  return (
    <ChatPageLayout
      ...
      onThreadHistoryOpen={controller.handleThreadHistoryOpen}
      ...
      threadHistory={controller.threadHistory}
      threadHistoryError={controller.threadHistoryError}
      threadHistoryLoading={controller.threadHistoryLoading}
