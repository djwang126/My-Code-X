...
function resolveCacheControl(frontendDistDir: any, absolutePath: any) {
...
export async function tryServeStaticApp(response: any, frontendDistDir: any, pathname: any) {
