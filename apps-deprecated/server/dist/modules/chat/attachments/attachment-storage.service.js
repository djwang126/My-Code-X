...
export function createAttachmentStorageService({ appDataRoot, metadataStore, now = () => new Date(), randomId = () => `att-${Date.now()}`, hashFile, }) {
    async function persistProcessedAttachment({ viewerId, threadId, workspaceRoot, originalFilename, processedFile }) {
...
//# sourceMappingURL=attachment-storage.service.js.map