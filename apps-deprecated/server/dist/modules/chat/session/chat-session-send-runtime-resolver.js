...
import { createThreadBootstrapState, sameAppliedThreadRuntimeOverrides, } from '../thread/thread-bootstrap-policy.js';
export function createGetOrCreateRuntimeForSend({ promptOverrideResolver, registry, sessionRecovery, startThreadForRuntime, }) {
    return async function getOrCreateRuntimeForSend({ viewerId, slotId, workspace = '', threadId, runtimeSettings, collaborationModeKind, }) {
        ...
        if (runtime?.threadId) {
            ...
            const hasRuntimeSettingsMismatch = !sameAppliedThreadRuntimeOverrides(runtime.appliedThreadRuntimeOverrides ?? null, requestedThreadRuntimeOverrides);
...
//# sourceMappingURL=chat-session-send-runtime-resolver.js.map