...
export function createPromptOverrideResolverWithFailures(failuresByPrompt) {
    return {
        async resolvePromptOverride(promptOverride) {
...
export function createUserTimelineMessage({ threadId, turnId, text }) {
...
export function createAssistantTimelineMessage({ threadId, turnId, text, state }) {
    return {
        id: `assistant:${turnId}`,
        kind: 'message',
...
//# sourceMappingURL=chat-service-test-helpers.js.map