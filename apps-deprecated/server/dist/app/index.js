...
const [{ authToken, codexBin, codexIdleShutdownConfig, codexWorkingDir, frontendDistDir, host, port, serverInstanceId, }, { startServer },] = await Promise.all([import('../config/config.js'), import('./server.js')]);
