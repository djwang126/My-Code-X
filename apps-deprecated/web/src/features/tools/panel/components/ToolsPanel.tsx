...
import { ReviewChooser, type ReviewStartTarget } from '../../review';
import { IconClose, IconFolder, IconRefresh, IconReview } from './ToolsPanelIcons';

type ToolsPanelActionHandler = () => boolean | Promise<boolean>;
...
type ToolsPanelProps = {
  ...
  onClose: () => void;
  onRestart?: ToolsPanelActionHandler;
  onWorkspaceExplorerOpen?: ToolsPanelActionHandler;
