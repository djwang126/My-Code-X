...
import { selectChatTodoState } from './todo-list-selector';
...
describe('selectChatTodoState', () => {
  ...
  it('ignores malformed or foreign-thread chat todo notices', () => {
    const state = selectChatTodoState(
      [
        createTodoNotice({
